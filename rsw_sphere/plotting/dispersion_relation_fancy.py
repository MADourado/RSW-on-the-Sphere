...
Run from the command line:
    ...
    python rsw_sphere/plotting/dispersion_relation_fancy.py output.png
    python rsw_sphere/plotting/dispersion_relation_fancy.py output.png --he 5000
    python -m rsw_sphere.plotting.dispersion_relation_fancy output.png
