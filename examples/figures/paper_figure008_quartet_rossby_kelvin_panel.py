...
IC, not the registry's own default (a=b=c=d=30 m/s), chosen to look for
new/lower-frequency periods generated by coupling the RH-only triad with
the Kelvin-like gravity mode EG(1,1).
